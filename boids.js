...
var ASM_CONSTS = {
  101720: () => { if (document.fullscreenElement) return 1; },  
 101766: () => { return Module.canvas.width; },  
 101798: () => { return parseInt(Module.canvas.style.width); },  
 101846: () => { document.exitFullscreen(); },  
 101873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101946: () => { if (document.fullscreenElement) return 1; },  
 101992: () => { return Module.canvas.width; },  
 102024: () => { return screen.width; },  
 102049: () => { document.exitFullscreen(); },  
 102076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102209: () => { return window.innerWidth; },  
 102235: () => { return window.innerHeight; },  
 102262: () => { if (document.fullscreenElement) return 1; },  
 102308: () => { return Module.canvas.width; },  
 102340: () => { return parseInt(Module.canvas.style.width); },  
 102388: () => { if (document.fullscreenElement) return 1; },  
 102434: () => { return Module.canvas.width; },  
 102466: () => { return screen.width; },  
 102491: () => { return window.innerWidth; },  
 102517: () => { return window.innerHeight; },  
 102544: () => { if (document.fullscreenElement) return 1; },  
 102590: () => { return Module.canvas.width; },  
 102622: () => { return screen.width; },  
 102647: () => { document.exitFullscreen(); },  
 102674: () => { if (document.fullscreenElement) return 1; },  
 102720: () => { return Module.canvas.width; },  
 102752: () => { return parseInt(Module.canvas.style.width); },  
 102800: () => { document.exitFullscreen(); },  
 102827: ($0) => { Module.canvas.style.opacity = $0; },  
 102865: () => { return screen.width; },  
 102890: () => { return screen.height; },  
 102916: () => { return window.screenX; },  
 102943: () => { return window.screenY; },  
 102970: () => { return window.devicePixelRatio; },  
 103006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103059: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 103110: () => { Module.canvas.style.cursor = 'none'; },  
 103147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103403: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 103454: () => { if (document.fullscreenElement) return 1; },  
 103500: () => { return window.innerWidth; },  
 103526: () => { return window.innerHeight; },  
 103553: () => { if (document.pointerLockElement) return 1; }
};
